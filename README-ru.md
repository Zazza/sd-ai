...
> **Примечание:** SD Studio подключается к вашему локальному [Stable Diffusion WebUI](https://github.com/AUTOMATIC1111/stable-diffusion-webui) и [OpenAI-совместимому LLM](https://url/). Всё работает на вашем железе — без облака, подписок и передачи данных.
...
- **Stable Diffusion WebUI** (A1111) — запускается с флагом `--api`. [Руководство](https://github.com/AUTOMATIC1111/stable-diffusion-webui). По умолчанию: `http://localhost:7860`
