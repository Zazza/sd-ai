...
export function ClearCompletedQueueJobs():Promise<void>;
...
export function DeleteServerModel(arg1:string,arg2:string):Promise<void>;

export function DeleteSession(arg1:number):Promise<void>;

export function DeleteSessionItem(arg1:number):Promise<void>;

export function DiscoverServers():Promise<Array<serverclient.DiscoveredServer>>;

export function DownloadServerModel(arg1:string,arg2:string,arg3:string):Promise<void>;

export function EnqueueCompareItem(arg1:generation.TestGenerateParams,arg2:number):Promise<number>;

export function EnqueueCompound(arg1:generation.GenerateCompoundImageParams):Promise<number>;

export function EnqueueFromImage(arg1:generation.GenerateFromImageParams):Promise<number>;

export function EnqueueTxt2Img(arg1:generation.GenerateImageParams):Promise<number>;
...
export function GetModelCatalog():Promise<serverclient.Catalog>;
...
export function GetPresetsInstallStatus():Promise<Array<preset.PresetInstallStatus>>;

export function GetQueue():Promise<Array<queue.Job>>;
...
export function GetServerModels(arg1:string):Promise<Array<serverclient.ModelInfo>>;

export function GetServerStatus():Promise<serverclient.ServerStatus>;
...
export function InstallPresetDeps(arg1:number):Promise<void>;
...
export function PrepareCompoundPresetsExport(arg1:Array<number>):Promise<string>;

export function PreparePresetsExport(arg1:Array<number>):Promise<string>;

export function PullServerLLMModel(arg1:string):Promise<void>;
...
export function RestartServerProcess(arg1:string):Promise<void>;

export function ResumePausedQueueJobs():Promise<number>;
...
export function StartServerProcess(arg1:string):Promise<void>;

export function StopServerProcess(arg1:string):Promise<void>;

export function SwitchServerBackend(arg1:string):Promise<void>;
